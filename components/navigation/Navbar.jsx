  ...
  const renderServicesMenu = (isMobileMenu = false) => (
    ...
    >
      <div className="services-toggle" onClick={handleServicesClick}>
        <span>Services</span>
        {isServicesOpen ? (
          <FaChevronUp style={{ marginLeft: "0.5em" }} />
        ) : (
        ...
        <nav className="top-navbar">
          <div className="container">
            <Link href="/" className="logo">
              <img src="/LogoPlacoDesign64.webp" alt="Logo Placo Design 64" />
            </Link>
          </div>
        </nav>
        ...
        {isMenuOpen && (
          <div className="mobile-menu-overlay" onClick={toggleMenu}>
            <div className="mobile-menu" onClick={(e) => e.stopPropagation()}>
              ...
              <Link href="/realisations" onClick={toggleMenu}>
                Réalisations
              </Link>
    ...
    <nav className="desktop-navbar">
      <div className="container">
        ...
        <div className="nav-right">
          ...
          {renderServicesMenu()}
          <Link href="/realisations" className="nav-link">
            Réalisations
          </Link>
          ...
          {isAuth ? (
            ...
            <Link href="/login" className="nav-link">
              <FaUser style={{ marginRight: "0.3em" }} /> Connexion
            </Link>
          )}
        </div>
      </div>
