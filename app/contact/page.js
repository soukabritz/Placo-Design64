      ...
      <div className="contact-page-flex">
        <div className="contact-intro-side">
          ...
          <p className="contact-intro-text">
            Pour un devis, un prix ou un renseignement, nous vous invitons à
            nous contacter par le formulaire ci-dessous.
            <br />
            ...
            <strong>
              ...
              questions et vous accompagner dans vos projets de rénovation.
              N'hésitez pas à nous donner un maximum de détails pour un retour
              personnalisé&nbsp;!
            </strong>
          </p>
        </div>
