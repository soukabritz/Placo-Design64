...
export const metadata = {
  title: "Conditions Générales d'Utilisation - Placo Design 64",
};
...
export default function ConditionsUtilisation() {
  return (
    <div className="legal-container">
      ...
      <p>Dernière mise à jour : 22/06/2025</p>

      <h2>1. Objet</h2>
      <p>
        Les présentes Conditions Générales d'Utilisation (CGU) ont pour objet de
        définir les modalités de mise à disposition du site Placo Design 64 et
        les conditions d'utilisation du service par l'Utilisateur.
      </p>

      <h2>2. Propriété intellectuelle</h2>
      <p>
        La structure générale du site, ainsi que les textes, graphiques, images
        et sons le composant sont la propriété de Placo Design 64. Toute
        représentation et/ou reproduction et/ou exploitation partielle ou totale
        des contenus et services proposés par le site, par quelque procédé que
        ce soit, sans l'autorisation préalable et par écrit de Placo Design 64
      ...
      <p>
        ...
        Placo Design 64 se réserve le droit de les corriger, dès que ces erreurs
