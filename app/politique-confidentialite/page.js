...
export const metadata = {
  title: "Politique de Confidentialité - Placo Design 64",
};
...
export default function PolitiqueConfidentialite() {
  return (
    <div className="legal-container">
      ...
      <p>
        Nous recueillons des informations lorsque vous nous contactez via le
      ...
      <p>
        ...
        transférées, ou données à une autre société sans votre consentement.
      </p>
      ...
      <p>
        ...
        réguliers. Cependant, cette utilisation des cookies n'est en aucune
        façon liée à des informations personnelles identifiables sur notre site.
      </p>
      ...
      <p>
        ...
        pouvez exercer ces droits à tout moment en nous contactant à{" "}
        <a href="mailto:abdelkader.biarritz@gmail.com">
          abdelkader.biarritz@gmail.com
        </a>
        .
      </p>
